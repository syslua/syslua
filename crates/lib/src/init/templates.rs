...
pub const INIT_LUA_TEMPLATE: &str = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../lua/syslua/template.lua"));

/// Embedded globals.d.lua type definitions
pub const GLOBALS_D_LUA: &str = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../lua/syslua/globals.d.lua"));
